...
namespace ElevatorConstants
{
    ...
    static constexpr units::meters_per_second_squared_t kMaxAcceleration = 160.0_in / (1_s * 1_s); // 460_in / (1_s * 1_s);
    ...
    static const units::meter_t kInitialHeightCorrection = 0.0_m;
